/*
 MÓDULO SENSOR LUZ - LDR:
 O Módulo pode ser conectado ao Arduino ligando-se o pino
 positivo (VCC) no 5V, o pino negativo (GND) no GND e o
 pino SINAL em um pino digital, como por exemplo A0.
 Assim, quando o LDR registrar uma alteração de resistência,
 será possível medir o nível de tensão de entrada no pino
 analógico correspondente.

 No caso desse exemplo os LEDs presentes no módulo serão
 utilizados para indicar a intensidade da luz incidente no LDR
 e serão ligados nos pinos digitais D8 (LED1), D9 (LED2) e
 D10 (LED3) do Arduino.
*/
/////////////////////////////////
